...
#'
#' @param data_eink Tabelle 73111-02 aus Lohn- und Einkommenssteuerbericht
...
create_dataframeReform<-function(
  ...
  Einkommenssteuer_over1mio_reform<-compute_Einkommensteuer(ZvEDurchschnitt_over1mio,gfb_reform, pg1s_reform, pg1e_reform, pg2s_reform, pg2e_reform, pp1s_reform, pp1e_reform, pp2s_reform)
  ...
  Einnahmen_over1mio_reform<-AnzahlSteuerpflichte_over1mio*Einkommenssteuer_over1mio_reform
  ...
  df<-data_vertZvE%>%
    mutate(ZvE=ZvE, #Anpassung!!!
           ...
           Einkommenssteuer_reform=compute_Einkommenssteuer(ZvE,gfb_reform, pg1s_reform, pg1e_reform, pg2s_reform, pg2e_reform, pp1s_reform, pp1e_reform, pp2s_reform),
           ...
           Durchschnittssteuersatz_reform=100*Einkommenssteuer_reform/ZvE,
           Einnahmen_reform=Einkommenssteuer_reform*Steuerpflichtige_norm_smooth,
           Entlastung_pcZvE=Durchschnittssteuersatz_base-Durchschnittssteuersatz_reform,
           Entlastung_absolut=Einkommenssteuer_base-Einkommenssteuer_reform,
    ...
    mutate(
      ...
      Soli_Grenzsteuersatz_reform=case_when(
        is.na(Einkommenssteuer_reform)~NA_real_,
        Einkommenssteuer_reform<solib_reform~0,
        (Einkommenssteuer_reform-solib_reform)*solig_reform/100<Einkommenssteuer_reform*solis_reform/100~solig_reform*Grenzsteuersatz_reform/100,
      ...
      Solitotal_reform=case_when(
        ...
        Soli_Grenzsteuersatz_reform==solig_reform*Grenzsteuersatz_reform/100~(Einkommenssteuer_reform-solib_reform)*solig_reform/100,
        Soli_Grenzsteuersatz_reform==solis_reform*Grenzsteuersatz_reform/100~Einkommenssteuer_reform*solis_reform/100
      ),
      Einkommenssteuer_inklSoli_base=Einkommenssteuer_base+Solitotal_base,
      Einkommenssteuer_inklSoli_reform=Einkommenssteuer_reform+Solitotal_reform,
      ...
      Durchschnittssteuersatz_inklSoli_reform=100*Einkommenssteuer_inklSoli_reform/ZvE,
      Einnahmen_inklSoli_reform=Einkommenssteuer_inklSoli_reform*Steuerpflichtige_norm_smooth,
      Entlastung_inklSoli_pcZvE=Durchschnittssteuersatz_inklSoli_base-Durchschnittssteuersatz_inklSoli_reform,
      Entlastung_inklSoli_absolut=Einkommenssteuer_inklSoli_base-Einkommenssteuer_inklSoli_reform,
