...
#' }
gen_plots_Reform<-function(df,breaks_gstdst=c(0,30000,60000,90000,120000),breaks_ent=c(10000,30000,100000,500000),max_x_gstdst=125000,max_y_gstdst=60,max_x_ent=500000,max_y_ent=NULL,width_ent=2,max_val=8,fast=FALSE){
